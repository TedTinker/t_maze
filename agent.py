...
from utils import args, plot_curiosity, device
...
class Agent:
    ...
    def __init__(self, action_prior="normal", my_args = args):
        ...
        self.trans_optimizer = optim.Adam(self.transitioner.parameters(), lr=self.args.lr)     
                           
        self.actor = Actor()
        self.actor_optimizer = optim.Adam(self.actor.parameters(), lr=self.args.lr)     
        
        self.critic1 = Critic()
        self.critic1_optimizer = optim.Adam(self.critic1.parameters(), lr=self.args.lr, weight_decay=0)
        self.critic1_target = Critic()
        self.critic1_target.load_state_dict(self.critic1.state_dict())

        self.critic2 = Critic()
        self.critic2_optimizer = optim.Adam(self.critic2.parameters(), lr=self.args.lr, weight_decay=0) 
